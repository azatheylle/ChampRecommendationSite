"""
Core recommendation logic — no Tkinter dependencies.

Note: basicinfo() was removed entirely (it relied on a Riot API key and was
not used by the recommendation flow).
"""
